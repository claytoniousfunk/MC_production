...
#+begin_src sh
  ...
  cp MC_production/pp_MC/PYTHIA8_DiJet_5360GeV/PYTHIA8_DiJet_5360GeV_genFragment.py Configuration/GenProduction/python/
#+end_src
...
#+begin_src sh
  cd MC_production/pp_MC/PYTHIA8_DiJet_5360GeV
#+end_src

Create the GEN-SIM executable with the macro:

#+begin_src sh
  ./PYTHIA8_DiJet_5360GeV_GEN-SIM.sh
#+end_src

Test that the executable runs properly:

#+begin_src sh
  cmsRun PYTHIA8_DiJet_5360GeV_GEN-SIM.py
#+end_src
