...
config.General.requestName = 'crabSubmit_RAW_QCD_pThat-15to1200_TuneCP5_13TeV_pythia8_withPU_2025-09-13'
config.General.workArea = config.General.requestName
config.General.transferOutputs = True

config.section_("JobType")
config.JobType.pluginName = 'Analysis'
config.JobType.psetName = 'QCD_pThat-15to1200_TuneCP5_13TeV_pythia8_RAW_withPU.py'
