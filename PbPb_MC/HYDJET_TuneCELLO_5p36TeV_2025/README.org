...
#+begin_src sh
  ...
  cmsrel CMSSW_15_1_1 # if you haven't created the CMSSW yet
  cd CMSSW_15_1_1/src
  cmsenv
#+end_src
...
#+begin_src sh
  ...
  cp MC_production/PbPb_MC/HYDJET_TuneCELLO_5p36TeV_2025/HYDJET_TuneCELLO_5p36TeV_2025_genFragment.py Configuration/GenProduction/python/
#+end_src
...
#+begin_src sh
  cd MC_production/PbPb_MC/HYDJET_TuneCELLO_5p36TeV_2025
#+end_src

Create the GEN-SIM executable with the macro:

#+begin_src sh
  ./HYDJET_TuneCELLO_5p36TeV_2025_GEN-SIM.sh
#+end_src

Test that the executable runs properly:

#+begin_src sh
  cmsRun HYDJET_TuneCELLO_5p36TeV_2025_GEN-SIM.py
#+end_src
